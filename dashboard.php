...
// Remove subdomain and creator_id logic
// Fetch all courses
$courses = getCourses();
        ...
        <div class="user-info">
            ...
            <div>
                ...
                <?php else: ?>
                    ...
                    <small class="text-muted">Browse Courses</small>
                <?php endif; ?>
            </div>
        </div>
    </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-2"><?php echo htmlspecialchars($course['course_code']); ?></p>
                                            <p class="card-text"><?php echo htmlspecialchars($course['description']); ?></p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge bg-primary"><?php echo htmlspecialchars($course['semester']); ?></span>
                                                <div class="d-flex gap-2">
                                                    <a href="course.php?id=<?php echo $course['id']; ?>" class="btn btn-outline-primary btn-sm text-nowrap">View Course</a>
                                                    <?php if (isLoggedIn() && isCR()): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Warning: This will delete the course and all its sections and materials!
                    </div>
                    <p>Are you sure you want to delete this course?</p>
                    <p class="text-danger" id="deleteCourseName"></p>
